...
function ValidatorDashboard() {
    ...
    const startScannerForBatch = (batch) => {
        ...
        setTimeout(() => {
            ...
            scannerRef.current.start(
                ...
                { fps: 5 }, // Scan slower to avoid overwhelming the user/network
                handleScanSuccess,
    ...
    if (loading) return <AppLayout><p className="text-center">Loading...</p></AppLayout>;
    if (error && mode === 'select_batch') return <AppLayout><p className="text-center text-red-400">{error}</p></AppLayout>;
